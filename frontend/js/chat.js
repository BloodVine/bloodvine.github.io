...
class ChatManager {
    ...
    setupSocket() {
        ...
        this.socket.on('user_joined', (data) => {
            this.app.showAlert(`${data.user_name} joined the room`, 'info');
        });

        this.socket.on('user_left', (data) => {
            this.app.showAlert(`${data.user_name} left the room`, 'info');
        });
    }
    ...
    async loadRooms() {
        // For now, we'll use predefined rooms
    ...
    async loadRoomHistory(roomId) {
        try {
            // In a real app, you'd fetch message history from the server
            // For now, we'll just show a welcome message
            this.displaySystemMessage(`Welcome to ${roomId} room!`);
        } catch (error) {
